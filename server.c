...
void send_metric(int sockfd, char* id){
	...
	if(strcmp(id,"sc_ra")==0){
		...
		sendDouble(sockfd,get_state(config.timing_box.pbob,config.timing_box.relay));
                ...
                sendDouble(sockfd,get_state(config.heaters.pbob,config.heaters.relay));
                ...
                sendDouble(sockfd,get_state(config.housekeeping.pbob,config.housekeeping.relay));
                ...
                sendDouble(sockfd,get_state(config.position_box.pbob,config.position_box.relay));
